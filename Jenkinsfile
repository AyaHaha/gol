  ...
  stages {
    ...
    stage('deploy') {
      ...
      steps {
        ...
        bat 'xcopy /y "C:\\Temp\\CICD Setup\\Jenkins_Slave\\workspace\\GOL_Pipleine\gameoflife-web\\target\\gameoflife.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 7.0\webapps"'
